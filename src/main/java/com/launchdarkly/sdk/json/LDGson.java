  ...
  private static class LDTypeAdapter<T> extends TypeAdapter<T> {
    ...
    public void write(JsonWriter out, T value) throws IOException {
      if (value == null) {
        ...
        JsonSerialization.gson.toJson(value, value.getClass(), new DelegatingJsonWriterAdapter(out));
      }
    }
  
    @Override
    public T read(JsonReader in) throws IOException {
      return JsonSerialization.gson.fromJson(new DelegatingJsonReaderAdapter(in), objectType);
    }
  }
